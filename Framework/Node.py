...
class Node:
    def __init__(self, node_id, energy_profile: EnergyProfile, lora_parameters, sleep_time, process_time, adr, location,
                 base_station: Gateway, env, payload_size, air_interface, MAX_DELAY_START_PER_NODE_MS, MAX_DELAY_BEFORE_SLEEP_MS,
                 confirmed_messages=True, massive_mimo_gain=False, number_of_antennas=1, printed=True):
        ...
        self.MAX_DELAY_START_PER_NODE_MS = MAX_DELAY_START_PER_NODE_MS
        self.MAX_DELAY_BEFORE_SLEEP_MS = MAX_DELAY_BEFORE_SLEEP_MS
    ...
    def run(self):
        ...
        for _ in range(1):
            ...
            if False and self.packets_sent < 20:
                payload_size = 5
